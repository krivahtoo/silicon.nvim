...
download() {
  ...
  if [ "$(uname)" == "Darwin" ]; then
    curl -fsSL https://github.com/krivahtoo/silicon.nvim/releases/download/$1/silicon-mac.tar.gz
    tar -xaf silicon-mac.tar.gz
  elif [ "$(expr substr $(uname -s) 1 5)" == "Linux" ]; then
    curl -fsSL https://github.com/krivahtoo/silicon.nvim/releases/download/$1/silicon-linux.tar.gz
    tar -xaf silicon-linux.tar.gz
  elif [ "$(expr substr $(uname -s) 1 10)" == "MINGW64_NT" ]; then
    curl -fsSL https://github.com/krivahtoo/silicon.nvim/releases/download/$1/silicon-win.zip
